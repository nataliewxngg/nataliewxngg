...
export default function Home() {
    ...
    const emailButtonSVG = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    const emailButtonSVGPath = document.createElementNS('http://www.w3.org/2000/svg', 'path');
    emailButtonSVG.setAttribute('viewBox', '0 0 24 24');
    emailButtonSVGPath.setAttribute(
        'd', 
    ...
    emailButtonSVG.appendChild(emailButtonSVGPath);
    ...
    const linkedInButtonSVG = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    const linkedInButtonSVGPath = document.createElementNS('http://www.w3.org/2000/svg', 'path');
    linkedInButtonSVG.setAttribute('viewBox', '0 0 50 50');
    linkedInButtonSVGPath.setAttribute(
        'd',
    ...
    linkedInButtonSVG.appendChild(linkedInButtonSVGPath);
    ...
    const githubButtonSVG = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    const githubButtonSVGPath = document.createElementNS('http://www.w3.org/2000/svg', 'path');
    githubButtonSVG.setAttribute('viewBox', '0 0 30 30');
    githubButtonSVGPath.setAttribute(
        'd',
    ...
    githubButtonSVG.appendChild(githubButtonSVGPath);
    ...
    const discordButtonSVG = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    const discordButtonSVGPath = document.createElementNS('http://www.w3.org/2000/svg', 'path');
    discordButtonSVG.setAttribute('viewBox', '0 -28.5 256 256');
    discordButtonSVGPath.setAttribute(
        'd', 
    ...
    discordButtonSVG.appendChild(discordButtonSVGPath);
